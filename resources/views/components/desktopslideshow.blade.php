                ...
                <div class="carousel-inner">
                      ...
                      <div class="carousel-item active">
                            ...
                            <div class="view overlay">
                              ...
                              <img class="img-fluid slideshowimage" src=" {{asset('slideshow/ảnh 2.jpg')}}" alt="Slide-1" style="width:100%;">
                              </div>
                              <div class="col-md-3 animated fadeInRight slow">
                              <img class="img-fluid slideshowimage" src=" {{asset('slideshow/ảnh 13.jpg')}}" alt="Slide-1" style="width:100%;">
                              </div>
