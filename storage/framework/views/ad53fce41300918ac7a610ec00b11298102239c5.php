<?php $__env->startSection('title'); ?> Gainaloe <?php $__env->stopSection(); ?>
...
<!-- About Starts Here -->
 ...
 <div id="About" class="container-fluid" style="background:white;">
    <br><br>
      <div class="row">
        <div class="col-md-4">
        <img src=" <?php echo e(asset('public/Img/1.jpg')); ?>" alt="" class="img-fluid" >
        </div>
        <div  align="center" class="col-md-8">
            <h1 class="black-text" style="font-weight:bold;">About Gainaloe</h1>
            ...
            <p  align="left" class="mx-5">
              <a href="<?php echo e(url('about')); ?>"  class="btn btn-dark">Know More</a>
              </p>
...
<section id="Products" align="center">
    ...
    <div  class="row "  >
      ...
      <div class="col-md-4 px-5">
          <img src=" <?php echo e(asset('public/Uploads/Products/'.$item->image1)); ?>" alt="" class="img-fluid" >
          
            <h2 class="black-text" style="font-weight:bold;"><?php echo e($item->name); ?></h2>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\ecommerce\resources\views/home.blade.php ENDPATH**/ ?>