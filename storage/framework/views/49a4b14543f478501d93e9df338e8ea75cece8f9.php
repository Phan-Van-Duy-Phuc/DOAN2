...
<div align="center" style="background:#1CD5E8;padding:20px;"> 
        ...
        <p class="white-text" style="font-weight:bold;"> 
            ...
            <a href="<?php echo e(url('admin-add-product')); ?>" class="badge badge-pill btn-dark disabled  px-3 py-2">   <i class="fas fa-plus"></i>  &nbsp; Add New Product</a> 
...
<div class="container py-5">
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
              <form method="POST" action="<?php echo e(url('admin-store-product')); ?>" enctype="multipart/form-data">
                  <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\ecommerce\resources\views/dashboards/admin/Products/add.blade.php ENDPATH**/ ?>